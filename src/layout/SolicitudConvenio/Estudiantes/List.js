...
const List = () => {
  ...
  const loadData = async ({ page = 0, rowsPerPage = 10 }) => {
    ...
    try {
      let url = `/convenios/${params.convenioId}/estudiantes/page/?page=${page}&pageSize=${rowsPerPage}`;
  ...
  const deleteOne = async () => {
    let source = CancelToken.source();
    try {
      let url = `/convenios/estudiantes/${toDelete}`;
        ...
        <Paper>
          <Box p={1}>
                ...
                {rows.map((row, index) => (
                  <TableRow key={index}>
                    <TableCell align="left">
                      {row.estudiante.cedulaIdentidad}
                    </TableCell>
                    <TableCell align="left">
                    ...
                    <TableCell align="left">
                      {row.estudiante?.carrera.descripcion}
                    </TableCell>
                    <TableCell align="left">
                      {row.estudiante?.materia}
                    </TableCell>
                          ...
                          <Tooltip title="Editar" aria-label="editar">
                            <IconButton
                              ...
                              onClick={() => history.push({
                                pathname: `/convenios/estudiantes/editar/${row.id}`,
                                state: {
                                  edit: true
                                }
                              })}
            ...
            >
              ...
              {hasRole(Roles.ROLE_USER) && (
                <Grid item className={classes.button}>
                  <Link to={`/convenios/estudiantes/crear/${params.convenioId}`}>
